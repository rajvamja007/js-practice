...
console.log(arr1.includes(9)); // check 9 is include or not and not include the fetch the boolean value of false
console.log(arr1.indexOf(9)); // another value of fetch then index time output is -1
